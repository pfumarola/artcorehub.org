        ...
        <form class="space-y-4" @submit.prevent="submit">
          <div class="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="mt-1 w-full rounded-lg border border-stone-200 bg-white/90 px-3 py-2.5 text-sm text-stone-900 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-stone-600 dark:bg-stone-800/90 dark:text-white"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              required
              class="mt-1 w-full resize-none rounded-lg border border-stone-200 bg-white/90 px-3 py-2.5 text-sm text-stone-900 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-stone-600 dark:bg-stone-800/90 dark:text-white"
            />
          </div>
          <button
            type="submit"
            class="rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-medium text-amber-950 hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:focus:ring-offset-stone-900"
          >
        ...
        <div v-if="!maintenanceMode">
          ...
          <ul class="mt-3 space-y-2">
            <li v-for="link in navLinks" :key="link.key">
              <NuxtLink
                :to="linkTo(link)"
                class="text-sm text-stone-600 hover:text-stone-900 focus:outline-none focus:ring-2 focus:ring-amber-500 dark:text-stone-400 dark:hover:text-white"
              >
                {{ $t(`nav.${link.key}`) }}
              </NuxtLink>
            </li>
